            ...
            <div class="row">
                <div class="col-xs-8 col-lg-8 col-md-8 col-sm-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="isRemember" type="checkbox" checked="${isRemember}"> 记住密码
                        </label>
                    </div>
                </div>
                <!-- /.col -->
...
<!-- jQuery 3 -->
<script src="static/assets/bower_components/jquery/dist/jquery.min.js" />
<!-- Bootstrap 3.3.7 -->
<script src="static/assets/bower_components/bootstrap/dist/js/bootstrap.min.js" />
<!-- iCheck -->
